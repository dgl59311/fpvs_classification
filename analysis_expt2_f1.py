...
sdt = list(filter(lambda s: 'expt_2_tp_fp_fn_tn' in s, os.listdir(results_dir)))
...
plt.savefig(os.path.join(main_dir, 'results', 'figures', 'Experiment_2_' + 'subj_9-14' + '.jpg'), dpi=500)
