...
f_titles = ['Experiment 1 - 6Hz vs 3Hz', 'Experiment 1 - 6Hz vs 9Hz', 'Experiment 1 - 6Hz vs 12Hz']
...
for id_ in range(9, 14):
    ...
    plt.legend(['6 Hz vs 3 Hz', '6 Hz vs 9 Hz', '6 Hz vs 12 Hz'], loc="upper right", ncol=1, fontsize=7)
