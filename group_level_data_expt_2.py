...
plt.show()
plt.tight_layout()
plt.savefig(os.path.join(main_dir, 'results', 'figures', 'Group_Experiment_2.jpg'), dpi=500)
...
ixp = 0
delticks = 1
# change idx_sr to idx_con. SRs are 2_2
...
for id_ in idx_con:
    ...
    if delticks == 1:
        ...
        plt.yticks([])
    plt.ylim(0.44, 0.78)  # Adjust according to your data range
    plt.plot([-1, 100], [0.5, 0.5], linestyle='--', color='green', alpha=0.4)
...
plt.tight_layout()
plt.savefig(os.path.join(main_dir, 'results', 'figures', 'Group_Experiment_2_3_dticks.jpg'), dpi=500)

# Create final figure by stacking the generated subplots
image1 = Image.open(os.path.join(main_dir, 'results', 'figures', 'Group_Experiment_2_2_dticks.jpg'))
image2 = Image.open(os.path.join(main_dir, 'results', 'figures', 'Group_Experiment_2.jpg'))
image3 = Image.open(os.path.join(main_dir, 'results', 'figures', 'Group_Experiment_2_3_dticks.jpg'))
...
combined_image.save(os.path.join(main_dir, 'results', 'figures', 'Experiment_2.jpg'))
combined_image.show()
